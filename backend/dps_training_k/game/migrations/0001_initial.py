# Generated by Django 5.0.1 on 2025-03-05 19:43
...
import helpers.completed_actions
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('frontend_id', models.CharField(editable=False, unique=True)),
                ...
                ('config', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='game.savedexercise')),
            ],
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, helpers.completed_actions.CompletedActionsMixin),
        ),
        migrations.AddField(
            model_name='actioninstance',
            name='lab',
        ...
        migrations.CreateModel(
            ...
            bases=(helpers.completed_actions.CompletedActionsMixin, helpers.eventable.Eventable, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('AC', 'action'), ('EX', 'exercise'), ('MA', 'material'), ('PE', 'personnel'), ('PA', 'patient')], max_length=2, null=True)),
                ('type', models.CharField(blank=True, choices=[('AR', 'arrived'), ('AS', 'assigned'), ('UA', 'unassigned'), ('ST', 'started'), ('FI', 'finished'), ('CA', 'canceled'), ('IE', 'in effect'), ('EX', 'expired'), ('MO', 'moved'), ('TR', 'triaged'), ('UP', 'updated')], max_length=2, null=True)),
